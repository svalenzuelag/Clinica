<%-- 
    Document   : PacientesU
    Created on : 26-oct-2020, 19:20:28
    Author     : josue
--%>
...
<html>
      ...
      %>
		...
		<div   class="wrapper d-flex align-items-xl-stretch" >
			<nav id="sidebar" class="active">
				<h1><a href="VistaUsuario.jsp" class="logo">Cli</a></h1>
  ...
  <form class="form-inline">
      <input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search" id="txt_Buscar" onkeyup="doSearch()"/>
          ...
          <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#modal_Paciente"onclick="limpiar()">Seleccionar</button>
        <div class="container">
